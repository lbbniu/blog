...
<img src="<?php echo imageurl(post_thumbnail_src(),'_185.110');?>" alt="<?php the_title();?>" />	<br><span class="r_title"><?php the_title();?></span></a>
		</li>
	...
	<li class="related_box"  >
		<a href="<?php the_permalink();?>" title="<?php the_title();?>" target="_blank">
		<img src="<?php echo post_thumbnail_src();?>_185.110" alt="<?php the_title();?>" /><br><span class="r_title"><?php the_title();?></span></a>
		</li>
