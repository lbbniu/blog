<?php
	...
	class Browser {
		...
		const PLATFORM_WINDOWS_NT62 = 'Windows 8';              //NT6.2
		const PLATFORM_WINDOWS_NT61 = 'Windows 7';              //NT6.1
		const PLATFORM_WINDOWS_NT60 = 'Windows Vista';          //NT6.0
		const PLATFORM_WINDOWS_NT51 = 'Windows XP';		        //NT5.1
		const PLATFORM_WINDOWS_NT52 = 'Windows 2003';           //NT5.2
		const PLATFORM_WINDOWS_NT5 = 'Windows 2000';            //NT5
		const PLATFORM_WINDOWS_NT49 = 'Windows ME';             //NT4.9
		const PLATFORM_WINDOWS_NT4 = 'Windows NT 4.0';          //NT4.0
		const PLATFORM_WINDOWS_98 = 'Windows 98';               //WIN 98
		const PLATFORM_WINDOWS_95 = 'Windows 95';               //WIN 95
		const PLATFORM_WINDOWS_CE = 'Windows CE';               //CE
	...
	/**
	 * Determine the user's platform (last updated 2013.04.19)
	 */
	protected function checkPlatform() 
	{
		if( stripos($this->_agent, 'NT 6.1') !== false ) $this->_platform = self::PLATFORM_WINDOWS_NT61;
		else if( stripos($this->_agent, 'NT 6.2') !== false ) $this->_platform = self::PLATFORM_WINDOWS_NT62;
		else if( stripos($this->_agent, 'NT 6.0') !== false ) $this->_platform = self::PLATFORM_WINDOWS_NT60;
		else if( stripos($this->_agent, 'NT 5.1') !== false ) $this->_platform = self::PLATFORM_WINDOWS_NT51;
		else if( stripos($this->_agent, 'NT 5.2') !== false ) $this->_platform = self::PLATFORM_WINDOWS_NT52;
		else if( stripos($this->_agent, 'NT 5') !== false ) $this->_platform = self::PLATFORM_WINDOWS_NT5;
		else if( stripos($this->_agent, 'NT 4.9') !== false ) $this->_platform = self::PLATFORM_WINDOWS_NT49;
		else if( stripos($this->_agent, 'NT 4.0') !== false ) $this->_platform = self::PLATFORM_WINDOWS_NT4;
		else if( stripos($this->_agent, '98') !== false ) $this->_platform = self::PLATFORM_WINDOWS_98;
		else if( stripos($this->_agent, '95') !== false ) $this->_platform = self::PLATFORM_WINDOWS_95;
		else if( stripos($this->_agent, 'CE') !== false ) $this->_platform = self::PLATFORM_WINDOWS_CE;
